...
//
// gerrors can be used by any package for simply handling and logging errors with very detailed
...
// Google's AIP 193 (https://google.aip.dev/193) which includes gRPC error message and status,
// alongside more information regarding the error represented by error details protocol buffer
// message (https://github.com/googleapis/googleapis/blob/master/google/rpc/error_details.proto#L111).
...
//
// This package has complete default formatter, but there is possibility to customize every aspect of it.
